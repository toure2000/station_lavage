...
public class WebSocketConfig implements WebSocketConfigurer {
	 @Autowired
	 public SocketConnectionHandlerChate socketConnectionHandlerChate;
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry webSocketHandlerRegistry) {
		...
		webSocketHandlerRegistry.addHandler(new SocketConnectionHandler(), "/googlemaps").setAllowedOrigins("*");
		webSocketHandlerRegistry.addHandler(socketConnectionHandlerChate, "/chate").setAllowedOrigins("*");
